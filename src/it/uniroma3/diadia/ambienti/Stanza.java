...
public class Stanza {
	...
	*/
    public String toString() {
    	...
    	else { risultato.append("Nessun attrezzo"); }
    		
    	if(this.personaggio != null) {
    		risultato.append("C'è "+this.personaggio.getClass().getSimpleName()+" "+this.personaggio.getNome()+" nella stanza prova a parlarci");
    	}
